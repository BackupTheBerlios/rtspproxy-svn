...
public class ProxySession
{
	...
	/**
	 * Creates a new ProxySession from a client side protocol session.
	 * 
	 * @param clientSession
	 */
	public ProxySession( ProtocolSession clientSession )
	{
	...
	private void connectServerSide( URI url ) throws IOException
	{
		...
		// Save current ProxySession into the ProtocolSession
