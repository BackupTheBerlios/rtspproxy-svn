...
public class ProxySession
{
	...
	private static Map<UnsignedLong, ProxySession> serverSessionIds = Collections.synchronizedMap( new HashMap<UnsignedLong, ProxySession>() );

	/** Map IDs for RTSP session with clients to ProxySession objects. */
	private static Map<UnsignedLong, ProxySession> clientSessionIds = Collections.synchronizedMap( new HashMap<UnsignedLong, ProxySession>() );
	 ...
	 */
	private static UnsignedLong newSessionID()
	{
		UnsignedLong id;
		while ( true ) {
			// Create a 64 bit random number
			synchronized ( random ) {
				id = new UnsignedLong( random );
			}
	...
	public UnsignedLong getClientSessionId()
	{
	...
	{
		return clientSessionId.toString();
	}

	public UnsignedLong getServerSessionId()
	{
		return serverSessionId;
	}

	public String getServerSessionIdString()
	{
		return serverSessionId.toString();
	}

	public void setClientSessionId( UnsignedLong clientSessionId )
	{
		this.clientSessionId = clientSessionId;
		clientSessionIds.put( clientSessionId, this );
	}

	public void setServerSessionId( UnsignedLong serverSessionId )
	{
	...
	public void setServerSessionId( String serverSessionId )
	{
		UnsignedLong id;
		try {
			id = UnsignedLong.fromString( serverSessionId );
		} catch ( NumberFormatException e ) {
			log.error( "Invalid serverSessionId string: " + serverSessionId );
			throw e;
		}
		this.serverSessionId = id;
		serverSessionIds.put( id, this );
	}
